...
using UpdateNight.TocReader.Textures.ASTC;
using UpdateNight.TocReader.Textures.BC;
using UpdateNight.TocReader.Textures.DXT;
using SkiaSharp;

namespace UpdateNight.TocReader.Textures
{
